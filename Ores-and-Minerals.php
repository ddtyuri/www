...
<head>
    <title>Ores-and-Minerals WinnerMac</title>
...
<div class="breadcrumbs margin-bottom-40">
	<div class="container">
        <h1 class="color-green pull-left">Ores-and-Minerals</h1>
        <ul class="pull-right breadcrumb">
            <li><a href="index.html">Home</a> <span class="divider">/</span></li>
            <li class="active">Ores-and-Minerals</li>
        </ul>
    </div><!--/container-->
</div><!--/breadcrumbs-->
<!--=== End Breadcrumbs ===-->
...
function myfun()
{
$("#Ores-and-Minerals").click(); // 触发了a标签的点击事件，但是没有触发页面跳转
		}
